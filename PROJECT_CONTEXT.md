...
metric icons use the shared compact icon surface, and the header's descriptor-
driven metric chips use explicit `ViewThatFits` rows/stacks rather than a lazy grid.

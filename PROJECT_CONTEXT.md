...
of multiple-choice options, and requires pinyin in the explanation. Radix does
not import a quiz result and must not offer a local dictionary-backed fallback
quiz for this page task. The AI Link

...
are immediately visible there. Study includes a compact `Backup files` bridge
to My Data so users can still distinguish local learning recovery from portable
file protection.

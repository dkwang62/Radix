...
class PersistenceManager:
    ...
    def try_restore(self):
        ...
        current_char = self.state.get_selected_component()
        current_stroke_char = self.state.get("stroke_view_char", "") if self.state.is_stroke_view_active() else ""
        if validated and validated not in {current_char, current_stroke_char}:

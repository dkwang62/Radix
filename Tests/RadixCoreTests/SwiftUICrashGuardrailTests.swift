...
struct SwiftUICrashGuardrailTests {
    ...
    func savedPageWorkspaceSwitcherIsShared() throws {
        ...
        #expect(switcher.contains("title: \"Switch\""))
        ...
        #expect(study.contains("studyPageSelectionSwitcher(rowData.collection, pages: pages)"))
        #expect(study.contains("studySavedPageActionsMenu(rowData.collection, usesCompactLabel: true)"))

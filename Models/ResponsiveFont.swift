...
public struct ResponsiveFont {
    ...
    public static let scalableCaption = Font.system(size: 18)
    public static let scalableCaption2 = Font.system(size: 16)
    ...
    public static let scalableCaption = Font.caption
    public static let scalableCaption2 = Font.caption2

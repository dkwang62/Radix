...
- `extracted_sentence_page_references`: lightweight links from saved pages to
  sentence-library rows stored in the separate sentence database export
...
Apple clients continue to read schemas 1–5. Schemas 1–4 encoded dates as
